...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function toggleFloatingNav() {
    ...
    // Find the reference section (you may need to adjust the selector)
    const referenceSection = document.querySelector('.reference') || document.querySelector('#reference') || document.querySelector('[id*="reference"]');
    
    if (scrollTop > abstractBottom) {
      // Check if we've scrolled past the reference section
      if (referenceSection) {
        const referenceTop = referenceSection.offsetTop;
        if (scrollTop > referenceTop) {
